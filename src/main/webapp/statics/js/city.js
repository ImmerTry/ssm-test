...
function getStockOpt(id, name) {
    ...
    $("#store-selector .address div").html(currentAreaInfo.currentProvinceName + cleanKuohao(currentAreaInfo.currentCityName) + cleanKuohao(currentAreaInfo.currentAreaName) + cleanKuohao(currentAreaInfo.currentTownName)).attr("title", address);
}
...
$("#store-selector .address").after(provinceHtml);
